...
public class Weapon implements XmlObject {
	...
	public static final String SHORT_TAG_NAME_STRING = "short";
	public static final String DESCRIPTION_TAG_NAME_STRING = "desc";
	public static final String TOOLTIP_TAG_NAME_STRING = "tooltip";
	public static final String COOLDOWN_TAG_NAME_STRING = "cooldown";
	public static final String POWER_TAG_NAME_STRING = "power";
	public static final String COST_TAG_NAME_STRING = "cost";
	public static final String RARITY_TAG_NAME_STRING = "rarity";
	public static final String DAMAGE_TAG_NAME_STRING = "damage";
	public static final String SHIELD_PIERCING_TAG_NAME_STRING = "sp";
	public static final String BP_TAG_NAME_STRING = "bp";
	public static final String FIRE_CHANCE_TAG_NAME_STRING = "fireChance";
	public static final String BREACH_CHANCE_TAG_NAME_STRING = "breachChance";
	public static final String IMAGE_TAG_NAME_STRING = "image";
	public static final String ICON_IMAGE_TAG_NAME_STRING = "iconImage";
	public static final String WEAPON_ART_TAG_NAME_STRING = "weaponArt";
	public static final String LAUNCH_SOUNDS_TAG_NAME_STRING = "launchSounds";
	public static final String SOUND_TAG_NAME_STRING = "sound";
	public static final String LENGTH_TAG_NAME_STRING = "length";
	public static final String COLOR_TAG_NAME_STRING = "color";
	public static final String R_TAG_NAME_STRING = "r";
	public static final String G_TAG_NAME_STRING = "g";
	public static final String B_TAG_NAME_STRING = "b";
	public static final String PROJECTILES_TAG_NAME_STRING = "projectiles";
	...
	public static final String LOCKED_TAG_NAME_STRING = "locked";
	public static final String WEAPON_BOOST_TAG_NAME_STRING = "boost";
	public static final String BOOST_TYPE_TAG_NAME_STRING = "type";
	public static final String BOOST_AMOUNT_TAG_NAME_STRING = "amount";
	public static final String BOOST_COUNT_TAG_NAME_STRING = "count";
	public static final String CHARGE_LEVELS_TAG_NAME_STRING = "chargeLevels";
